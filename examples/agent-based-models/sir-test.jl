...
function testfun(N_adapt::Int64, N_samples::Int64, vmultiplier::Float64,
        alphalevels::Vector{Float64}, iter::Int64, 
        abmpars::Vector{Float64}, options::Optim.Options = Optim.Options()) 
...
res = testfun(N_adapt, N_samples, vmultiplier, alphalevels, 1, abmpars, options)

abmpars = [10, 0.05, 3, 0, 0.0005, 0.005]  # i, B, inf, dt, speed, inf rad
res = testfun(10, 10, vmultiplier, alphalevels, 1, abmpars, options)
